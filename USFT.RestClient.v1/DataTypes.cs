...
namespace USFT.RestClient.v1
{
    ...
    public class Address
    {
        ...
        public Address() { }
        public Address(ulong AccountId, ulong AddressId, string Name, string AddressBlock, double Latitude, double Longitude, string Image,
    ...
    public class Alert
    {
        ...
        public ulong AccountId;
        /// <summary>
        /// A unique identifier for the Alert. Use this when making further API calls specific to this Alert.
        /// </summary>
        public ulong AlertId;
        /// <summary>
